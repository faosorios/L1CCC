...
[![fastmatrix](https://img.shields.io/badge/fastmatrix-0.6--6-orange)](https://cran.r-project.org/package=fastmatrix)
[![MVT](https://img.shields.io/badge/MVT-0.3--81-orange)](https://cran.r-project.org/package=MVT)
[![L1pack](https://img.shields.io/badge/L1pack-0.62-orange)](https://cran.r-project.org/package=L1pack)
...
Attached packages: fastmatrix 0.6-6, MVT 0.3-81, L1pack 0.62, plot3D 1.4.1
...
CONTENTS:
- case_study/PSG.R: R commands for the analysis of Transient sleep disorder dataset (described/analyzed at Sections 1 and 3.2 from manuscript).
- case_study/suppl: R commands for creation of Figure 1(a) and 1(b) from Supplementary material.
- plots/plots.R: R commands for the construction of Figures 3 and 4.
- plots/bound.R: R function and commands required to plotting Figure 3.
- code/center_test.R: R functions to compute Wald, Rao score, gradient and Hotelling T-square test statistics.
- code/envelope.R: R function for QQ-plot with envelopes based on normalized quantile variables. 
